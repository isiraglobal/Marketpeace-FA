          ...
          <Suspense fallback={
            <div className="min-h-screen bg-transparent flex items-center justify-center">
              <div className="flex gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-[#0DB8D3] animate-bounce" style={{ animationDelay: '0ms' }} />
                <span className="w-1.5 h-1.5 rounded-full bg-[#0DB8D3] animate-bounce" style={{ animationDelay: '120ms' }} />
                <span className="w-1.5 h-1.5 rounded-full bg-[#0DB8D3] animate-bounce" style={{ animationDelay: '240ms' }} />
              </div>
            </div>
          }>
            <Routes>
