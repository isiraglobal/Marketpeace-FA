  ...
  return (
    <div className="w-full min-h-screen pt-20 sm:pt-24 md:pt-32 px-4 sm:px-6 md:px-8 flex flex-col items-center pb-12 sm:pb-16 md:pb-24">
      ...
      >
        ...
        <h1 className="text-2xl sm:text-4xl md:text-6xl font-black tracking-tighter mb-6 md:mb-10 text-white leading-[0.95] uppercase italic">Transparency & <span className="not-italic text-[#1B7FDC]">Security</span></h1>
        ...
        <div className="liquid-glass p-6 md:p-8 group transition-all">
          <FileText className="w-8 h-8 md:w-10 md:h-10 text-[#0DB8D3] mb-6" />
          ...
          <Link to="/privacy" className="flex items-center gap-2 text-[#0DB8D3] text-[10px] md:text-sm font-bold tracking-widest uppercase group-hover:gap-3 transition-all">
            Read Policy <ArrowRight className="w-4 h-4" />
          </Link>
        </div>

        <div className="liquid-glass p-6 md:p-8 group transition-all">
          <ShieldCheck className="w-8 h-8 md:w-10 md:h-10 text-[#0DB8D3] mb-6" />
          ...
          <Link to="/terms" className="flex items-center gap-2 text-[#0DB8D3] text-[10px] md:text-sm font-bold tracking-widest uppercase group-hover:gap-3 transition-all">
        ...
        <div className="liquid-glass p-6 md:p-8 md:col-span-2 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <a href="mailto:foreignaffairsllc2017@gmail.com?subject=Vendor%20Agreement%20Request" className="w-full md:w-auto px-10 py-3.5 bg-white text-[#193546] font-bold rounded-xl tracking-widest text-[12px] md:text-xs uppercase hover:bg-white/90 transition-all shadow-xl whitespace-nowrap btn-glow inline-block text-center">
            REQUEST AGREEMENT
          </a>
        </div>
      </div>
